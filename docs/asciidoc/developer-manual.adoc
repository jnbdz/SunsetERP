...
include::docs/org/sitenetsoft/sunseterp/framework/webapp/webapp.adoc[leveloffset=+1]
...
include::docs/org/sitenetsoft/sunseterp/framework/entity/entity-engine.adoc[leveloffset=+1]
...
include::docs/org/sitenetsoft/sunseterp/framework/datafile/datafiles.adoc[leveloffset=+2]

=== Entity engine configuration

=== Supported databases

include::docs/org/sitenetsoft/sunseterp/applications/datamodel/DATAMODEL_CHANGES.adoc[leveloffset=+2]
...
include::docs/org/sitenetsoft/sunseterp/framework/minilang/minilang-to-groovy-manual.adoc[leveloffset=+1]

== Testing

include::docs/org/sitenetsoft/sunseterp/framework/testtools/unit-tests.adoc[leveloffset=+2]
...
include::docs/org/sitenetsoft/sunseterp/framework/base/email.adoc[leveloffset=+2]

include::docs/org/sitenetsoft/sunseterp/framework/security/security.adoc[leveloffset=+1]
