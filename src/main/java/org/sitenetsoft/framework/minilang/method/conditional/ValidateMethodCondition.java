 ...
 * under the License.
 *******************************************************************************/
package org.sitenetsoft.framework.minilang.method.conditional;
...
import org.sitenetsoft.framework.minilang.*;
...
public final class ValidateMethodCondition extends MethodOperation implements Conditional {
    ...
    private static final Class<?>[] PARAM_TYPES = new Class<?>[] {String.class };
    ...
    public ValidateMethodCondition(Element element, SimpleMethod simpleMethod) throws MiniLangException {
        ...
        this.className = MiniLangValidate.checkAttribute(element.getAttribute("class"), "org.sitenetsoft.framework.base.util.UtilValidate");
    ...
    public boolean checkCondition(MethodContext methodContext) throws MiniLangException {
        ...
        try {
            ...
            Method valMethod = valClass.getMethod(methodName, PARAM_TYPES);
    ...
    public String toString() {
        ...
        if (!"org.sitenetsoft.framework.base.util.UtilValidate".equals(this.className)) {
