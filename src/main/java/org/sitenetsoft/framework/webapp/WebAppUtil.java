 ...
 * under the License.
 *******************************************************************************/
package org.sitenetsoft.framework.webapp;
...
import org.sitenetsoft.framework.base.util.UtilXml.LocalErrorHandler;
import org.sitenetsoft.framework.base.util.UtilXml.LocalResolver;
...
import org.sitenetsoft.framework.webapp.event.RequestBodyMapHandlerFactory;
...
public final class WebAppUtil {
     ...
     * @throws IOException
     */
    public static WebappInfo getWebappInfoFromWebsiteId(String webSiteId) throws IOException {
     ...
     * @throws IOException
     */
    public static String getControlServletPath(WebappInfo webAppInfo) throws IOException {
        /*Assert.notNull("webAppInfo", webAppInfo);
        String servletMapping = null;
        //WebXml webXml = getWebXml(webAppInfo);
        for (ServletDef servletDef : webXml.getServlets().values()) {
            if ("org.sitenetsoft.framework.webapp.control.ControlServlet".equals(servletDef.getServletClass())
                    || "org.sitenetsoft.framework.product.category.SeoControlServlet".equals(servletDef.getServletClass())) {
        ...
        if (servletMapping == null) {
            Debug.logWarning("org.sitenetsoft.framework.webapp.control.ControlServlet mapping not found in "
