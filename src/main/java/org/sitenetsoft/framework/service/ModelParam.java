...
// Method to retrieve form-label from model parameter object in freemarker
    ...
    protected String java2wsdlType() {
        if (ObjectType.instanceOf(Character.class, this.type)) {
            ...
            return "sql-Timestamp";
        } else if (ObjectType.instanceOf(org.sitenetsoft.framework.entity.GenericValue.class, this.type)) {
            return "eeval-";
        } else if (ObjectType.instanceOf(org.sitenetsoft.framework.entity.GenericPK.class, this.type)) {
            return "eepk-";
