 ...
 * under the License.
 *******************************************************************************/
package org.sitenetsoft.framework.service.calendar;
...
public class TemporalExpressions implements Serializable {
    ...
    public static class DateRange extends TemporalExpression {
        ...
        private final org.sitenetsoft.framework.base.util.DateRange range;
        ...
        public DateRange(Date start, Date end) {
            this.range = new org.sitenetsoft.framework.base.util.DateRange(start, end);
        ...
        /** Returns the contained <code>org.sitenetsoft.framework.base.util.DateRange</code>.
         * @return The contained <code>org.sitenetsoft.framework.base.util.DateRange</code>
         */
        public org.sitenetsoft.framework.base.util.DateRange getDateRange() {
            return this.range;
        }
