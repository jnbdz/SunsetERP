...
/*public class RmiServiceContainer implements Container {
    ...
    public boolean start() throws ContainerException {
        ...
        if (ssf != null && ssf instanceof org.sitenetsoft.framework.service.rmi.socket.ssl.SSLServerSocketFactory) {
            // CHECKSTYLE_OFF: ALMOST_ALL
            ((org.sitenetsoft.framework.service.rmi.socket.ssl.SSLServerSocketFactory) ssf).setNeedClientAuth(clientAuth);
            ((org.sitenetsoft.framework.service.rmi.socket.ssl.SSLServerSocketFactory) ssf).setKeyStoreAlias(ksAlias);
            if (keystore != null) {
                ((org.sitenetsoft.framework.service.rmi.socket.ssl.SSLServerSocketFactory) ssf).setKeyStore(keystore, ksType, ksPass);
            }
