 ...
 * under the License.
 *******************************************************************************/
package org.sitenetsoft.framework.service.rmi;

import org.sitenetsoft.framework.service.GenericRequester;
import org.sitenetsoft.framework.service.GenericResultWaiter;
...
public interface RemoteDispatcher extends Remote {
     ...
     * @throws RemoteException
     */
    void runSyncIgnore(String serviceName, Map<String, ? extends Object> context) throws GenericServiceException, RemoteException;
     ...
     * @throws RemoteException
     */
    void schedule(String serviceName, Map<String, ? extends Object> context, long startTime, int frequency, int interval, int count, long endTime)
            throws GenericServiceException, RemoteException;
     ...
     * @throws RemoteException
     */
    void schedule(String serviceName, Map<String, ? extends Object> context, long startTime, int frequency, int interval, int count)
            throws GenericServiceException, RemoteException;
     ...
     * @throws RemoteException
     */
    void schedule(String serviceName, Map<String, ? extends Object> context, long startTime, int frequency, int interval, long endTime)
            throws GenericServiceException, RemoteException;
