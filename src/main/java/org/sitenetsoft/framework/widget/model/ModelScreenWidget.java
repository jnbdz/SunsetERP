...
import org.sitenetsoft.framework.widget.WidgetFactory;
import org.sitenetsoft.framework.widget.model.CommonWidgetModels.*;
import org.sitenetsoft.framework.widget.portal.PortalPageWorker;
...
public abstract class ModelScreenWidget extends ModelWidget {
    ...
    public static final class SectionsRenderer implements Map<String, ModelScreenWidget> {
        ...
        @Override
        public Set<Entry<String, ModelScreenWidget>> entrySet() {
