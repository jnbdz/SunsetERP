 ...
 * under the License.
 *******************************************************************************/
package org.sitenetsoft.framework.widget.content;
...
public final class WidgetDataResourceWorker {
    ...
    static {
        try {
            ...
            dataresourceWorker = (DataResourceWorkerInterface) loader.loadClass("org.sitenetsoft.framework.content.data.DataResourceWorker")
