 ...
 * under the License.
 *******************************************************************************/
package org.sitenetsoft.framework.entity.config.model;
...
public final class DelegatorElement {
    ...
    DelegatorElement(Element element) throws GenericEntityConfException {
        ...
        if (entityEcaHandlerClassName.isEmpty()) {
            entityEcaHandlerClassName = "org.sitenetsoft.framework.entityext.eca.DelegatorEcaHandler";
        }
        ...
        if (distributedCacheClearClassName.isEmpty()) {
            distributedCacheClearClassName = "org.sitenetsoft.framework.entityext.cache.EntityCacheServices";
        }
        ...
        if (defaultGroupName.isEmpty()) {
            defaultGroupName = "org.sitenetsoft.framework";
        }
