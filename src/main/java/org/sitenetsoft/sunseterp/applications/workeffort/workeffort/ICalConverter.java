...
import org.sitenetsoft.sunseterp.framework.service.calendar.TemporalExpressionWorker;
import org.sitenetsoft.sunseterp.applications.workeffort.workeffort.ICalWorker.ResponseProperties;
...
public class ICalConverter {
    ...
    protected static final Map<String, Status> TO_STATUS_MAP = UtilMisc.toMap(
            "CAL_TENTATIVE",
            ...
            "CAL_NEEDS_ACTION",
            ImmutableStatus.VTODO_NEEDS_ACTION,
            "CAL_COMPLETED",
            ImmutableStatus.VTODO_COMPLETED,
            "CAL_ACCEPTED",
            ImmutableStatus.VTODO_IN_PROCESS);
