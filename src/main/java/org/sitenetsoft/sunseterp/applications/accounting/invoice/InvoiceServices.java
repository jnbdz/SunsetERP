...
import org.sitenetsoft.sunseterp.applications.accounting.payment.PaymentWorker;
import org.sitenetsoft.sunseterp.applications.accounting.util.UtilAccounting;
...
import org.sitenetsoft.sunseterp.framework.order.order.OrderReadHelper;
import org.sitenetsoft.sunseterp.framework.product.product.ProductWorker;
...
public class InvoiceServices {
    ...
    public static Map<String, Object> createInvoiceForOrder(DispatchContext dctx, Map<String, Object> context) {
        ...
        try {
            ...
            for (Entry<GenericValue, BigDecimal> set : shipAdjustments.entrySet()) {
            ...
            for (Entry<GenericValue, BigDecimal> entry : taxAdjustments.entrySet()) {
    ...
    public static Map<String, Object> createCommissionInvoices(DispatchContext dctx, Map<String, Object> context) {
        ...
        for (Entry<String, List<Map<String, Object>>> commissionParty : commissionParties.entrySet()) {
        ...
        for (Entry<String, List<GenericValue>> order : shippedOrderItems.entrySet()) {
            ...
            if ("N".equalsIgnoreCase(prorateShipping)) {
                ...
                if (totalAdditionalShippingCharges.signum() == 1) {
                    ...
                    for (Entry<GenericValue, BigDecimal> entry : additionalShippingCharges.entrySet()) {
    ...
    public static Map<String, Object> createInvoicesFromReturnShipment(DispatchContext dctx, Map<String, Object> context) {
        ...
        try {
            ...
            for (Entry<String, List<GenericValue>> entry : itemsShippedGroupedByReturn.entrySet()) {
