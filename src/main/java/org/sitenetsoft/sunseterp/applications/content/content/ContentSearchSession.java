...
public class ContentSearchSession {
    ...
    public static class ContentSearchOptions implements java.io.Serializable {
        private List<ContentSearch.ContentSearchConstraint> constraintList = null;
        private ContentSearch.ResultSortOrder resultSortOrder = null;
        ...
        public static List<ContentSearch.ContentSearchConstraint> getConstraintList(HttpSession session) {
        ...
        public static ContentSearch.ResultSortOrder getResultSortOrder(HttpServletRequest request) {
        ...
        public List<String> searchGetConstraintStrings(boolean detailed, Delegator delegator, Locale locale) {
            List<ContentSearch.ContentSearchConstraint> contentSearchConstraintList = this.getConstraintList();
            List<String> constraintStrings = new LinkedList<>();
            if (contentSearchConstraintList == null) {
                return constraintStrings;
            }
            for (ContentSearch.ContentSearchConstraint contentSearchConstraint: contentSearchConstraintList) {
    ...
    public static void searchAddConstraint(ContentSearch.ContentSearchConstraint contentSearchConstraint, HttpSession session) {
        ContentSearchOptions.addConstraint(contentSearchConstraint, session);
    }
    public static void searchSetSortOrder(ContentSearch.ResultSortOrder resultSortOrder, HttpSession session) {
    ...
    public static String searchGetSortOrderString(boolean detailed, HttpServletRequest request) {
        ...
        ContentSearch.ResultSortOrder resultSortOrder = ContentSearchOptions.getResultSortOrder(request);
    ...
    public static void searchRemoveConstraint(int index, HttpSession session) {
        List<ContentSearch.ContentSearchConstraint> contentSearchConstraintList = ContentSearchOptions.getConstraintList(session);
        if (contentSearchConstraintList == null) {
            return;
