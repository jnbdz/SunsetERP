...
public class ContentSearchEvents {
    ...
    public static Map<String, Object> getContentSearchResult(HttpServletRequest request, Delegator delegator) {
        ...
        List<ContentSearch.ContentSearchConstraint> contentSearchConstraintList = ContentSearchSession.ContentSearchOptions.getConstraintList(session);
        ...
        if (UtilValidate.isNotEmpty(contentSearchConstraintList)) {
            ...
            ContentSearch.ResultSortOrder resultSortOrder = ContentSearchSession.ContentSearchOptions.getResultSortOrder(request);
