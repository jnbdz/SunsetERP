 ...
 * under the License.
 *******************************************************************************/
package org.sitenetsoft.sunseterp.applications.content.data;
...
import org.sitenetsoft.sunseterp.framework.base.util.template.XslTransform;
import org.sitenetsoft.sunseterp.framework.common.email.NotificationServices;
import org.sitenetsoft.sunseterp.framework.refactor.JakartaRequestContext;
import org.sitenetsoft.sunseterp.applications.content.content.UploadContentAndImage;
...
import org.sitenetsoft.sunseterp.framework.widget.renderer.ScreenStringRenderer;
import org.sitenetsoft.sunseterp.framework.widget.renderer.VisualTheme;
import org.sitenetsoft.sunseterp.framework.widget.renderer.macro.MacroFormRenderer;
 ...
 */
public class DataResourceWorker implements org.sitenetsoft.sunseterp.framework.widget.content.DataResourceWorkerInterface {
    ...
    public static String uploadAndStoreImage(HttpServletRequest request, String idField, String uploadField) {
        ...
        try {
            lst = UtilGenerics.cast(fu.parseRequest(requestContext));
