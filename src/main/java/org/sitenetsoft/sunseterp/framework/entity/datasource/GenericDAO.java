...
import org.sitenetsoft.sunseterp.framework.entity.condition.EntityConditionParam;
...
import org.sitenetsoft.sunseterp.framework.entity.jdbc.SQLProcessor;
...
public class GenericDAO {
    ...
    public int updateByCondition(ModelEntity modelEntity, Map<String, ? extends Object> fieldsToSet, EntityCondition condition, SQLProcessor sqlP)
        ...
        if (modelEntity instanceof ModelViewEntity) {
            throw new org.sitenetsoft.sunseterp.framework.entity.GenericNotImplementedException("Operation updateByCondition not supported yet for view entities");
        }
    ...
    public void partialSelect(GenericEntity entity, Set<String> keys) throws GenericEntityException {
        ...
        if (modelEntity instanceof ModelViewEntity) {
            throw new org.sitenetsoft.sunseterp.framework.entity.GenericNotImplementedException("Operation partialSelect not supported yet for view entities");
        }
    ...
    public int delete(GenericEntity entity, SQLProcessor sqlP) throws GenericEntityException {
        ...
        if (modelEntity instanceof ModelViewEntity) {
            throw new org.sitenetsoft.sunseterp.framework.entity.GenericNotImplementedException("Operation delete not supported yet for view entities");
        }
    ...
    public int deleteByCondition(ModelEntity modelEntity, EntityCondition condition, SQLProcessor sqlP) throws GenericEntityException {
        ...
        if (modelEntity instanceof ModelViewEntity) {
            throw new org.sitenetsoft.sunseterp.framework.entity.GenericNotImplementedException("Operation deleteByCondition not supported yet for view entities");
        }
