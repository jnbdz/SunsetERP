...
import org.sitenetsoft.sunseterp.framework.entity.GenericEntityNotFoundException;
...
public class EntitySaxReader extends DefaultHandler {
    ...
    private long parse(InputStream is, String docDescription) throws SAXException, IOException {
        SAXParser parser;
        try {
