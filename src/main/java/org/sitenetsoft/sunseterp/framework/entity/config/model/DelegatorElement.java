...
public final class DelegatorElement {
    ...
    DelegatorElement(Element element) throws GenericEntityConfException {
        ...
        if (entityEcaHandlerClassName.isEmpty()) {
            entityEcaHandlerClassName = "org.sitenetsoft.sunseterp.framework.entityext.eca.DelegatorEcaHandler";
        }
        ...
        if (distributedCacheClearClassName.isEmpty()) {
            distributedCacheClearClassName = "org.sitenetsoft.sunseterp.framework.entityext.cache.EntityCacheServices";
        }
        ...
        if (defaultGroupName.isEmpty()) {
            defaultGroupName = "org.sitenetsoft.sunseterp.framework";
        }
