 ...
 * under the License.
 *******************************************************************************/
package org.sitenetsoft.sunseterp.framework.service.calendar;
...
public class TemporalExpressions implements Serializable {
    ...
    public static class DateRange extends TemporalExpression {
        ...
        private final org.sitenetsoft.sunseterp.framework.base.util.DateRange range;
        ...
        public DateRange(Date start, Date end) {
            this.range = new org.sitenetsoft.sunseterp.framework.base.util.DateRange(start, end);
        ...
        /** Returns the contained <code>org.sitenetsoft.sunseterp.framework.base.util.DateRange</code>.
         * @return The contained <code>org.sitenetsoft.sunseterp.framework.base.util.DateRange</code>
         */
        public org.sitenetsoft.sunseterp.framework.base.util.DateRange getDateRange() {
            return this.range;
        }
