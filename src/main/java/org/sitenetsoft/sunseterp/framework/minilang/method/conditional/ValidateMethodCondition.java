...
import org.sitenetsoft.sunseterp.framework.minilang.*;
...
public final class ValidateMethodCondition extends MethodOperation implements Conditional {
    ...
    public ValidateMethodCondition(Element element, SimpleMethod simpleMethod) throws MiniLangException {
        ...
        this.className = MiniLangValidate.checkAttribute(element.getAttribute("class"), "org.sitenetsoft.sunseterp.framework.base.util.UtilValidate");
    ...
    public String toString() {
        ...
        if (!"org.sitenetsoft.sunseterp.framework.base.util.UtilValidate".equals(this.className)) {
