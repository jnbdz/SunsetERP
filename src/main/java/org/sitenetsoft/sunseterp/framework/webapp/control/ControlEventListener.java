...
public class ControlEventListener implements HttpSessionListener {
    ...
    public void sessionCreated(HttpSessionEvent event) {
        ...
        if (System.getProperty("org.sitenetsoft.sunseterp.framework.log.session.stats") != null) {
            session.setAttribute("org.sitenetsoft.framework.log.session.stats", "Y");
        }
    ...
    public void logStats(HttpSession session, GenericValue visit) {
        if (Debug.verboseOn() || session.getAttribute("org.sitenetsoft.framework.log.session.stats") != null) {
