...
public final class Debug {
    ...
    static {
        ...
        Properties properties = UtilProperties.createProperties("org/sitenetsoft/sunseterp/framework/base/config/debug.properties");
        if (properties != null) {
    ...
    public static void log(int level, Throwable t, String msg, String module) {
        log(level, t, msg, module, "org.sitenetsoft.sunseterp.framework.base.util.Debug", EMPTY_PARAMS);
    }

    public static void log(int level, Throwable t, String msg, String module, Object... params) {
        log(level, t, msg, module, "org.sitenetsoft.sunseterp.framework.base.util.Debug", params);
    }
