...
import static org.sitenetsoft.sunseterp.framework.base.util.UtilProperties.getPropertyValue;

/**
 * SafeObjectInputStream
 *
 * <p> An implementation of {@link ObjectInputStream} that ensure that
...
public final class SafeObjectInputStream extends ObjectInputStream {
    private static final String[] DEFAULT_ALLOWLIST_PATTERN = {
            ...
            "\\[Z", "\\[B", "\\[S", "\\[I", "\\[J", "\\[F", "\\[D", "\\[C",
            "java..*", "sun.util.calendar..*", "org.sitenetsoft.sunseterp.framework..*",
