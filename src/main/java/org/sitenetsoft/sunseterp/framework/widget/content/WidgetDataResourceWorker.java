 ...
 * under the License.
 *******************************************************************************/
package org.sitenetsoft.sunseterp.framework.widget.content;
...
public final class WidgetDataResourceWorker {
    ...
    static {
        try {
            ...
            dataresourceWorker = (DataResourceWorkerInterface) loader.loadClass("org.sitenetsoft.sunseterp.framework.content.data.DataResourceWorker")
