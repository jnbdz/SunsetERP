...
import org.sitenetsoft.sunseterp.framework.widget.model.MenuFactory;
import org.sitenetsoft.sunseterp.framework.widget.model.ModelMenu;
...
public class HtmlMenuWrapper {
    ...
    public static HtmlMenuWrapper getMenuWrapper(HttpServletRequest request, HttpServletResponse response, HttpSession session,
        ...
        if (menuWrapper == null) {
            try {
                Class<?> cls = Class.forName("org.sitenetsoft.sunseterp.framework.widget.html." + menuWrapperClassName);
