...
<#if temporalExpression?has_content>
  ...
  <#else>
    ...
    <#elseif "INTERSECTION.UNION.DIFFERENCE.SUBSTITUTION"?contains(temporalExpression.tempExprTypeId)>
      <#assign candidateIdList = Static["org.sitenetsoft.sunseterp.framework.service.calendar.ExpressionUiHelper"].getCandidateIncludeIds(delegator, temporalExpression.tempExprId)/>
