                                            ...
                                            <fo:table-body>
                                                ...
                                                <fo:table-row>
                                                    <fo:table-cell padding-before="0.8cm">
                                                        <fo:block margin-left="3.0cm">
                                                            <#assign toPartyNameResult = dispatcher.runSync("getPartyNameForDate", Static["org.sitenetsoft.sunseterp.framework.base.util.UtilMisc"].toMap("partyId", payment.partyIdTo, "compareDate", payment.effectiveDate, "userLogin", userLogin))/>
                                                ...
                                                <fo:table-row>
                                                    <fo:table-cell number-columns-spanned="2">
                                                        <#assign amount = Static["org.sitenetsoft.sunseterp.framework.base.util.UtilNumber"].formatRuleBasedAmount(payment.getDouble("amount"), locale).toUpperCase()>
                                        ...
                                        <fo:table table-layout="fixed" margin-left="5pt" margin-right="5pt" width="100%">
                                            ...
                                            <fo:table-header>
                                                <fo:table-row>
                                                    <fo:table-cell padding="3pt" number-columns-spanned="3" text-align="center">
                                                        <fo:block text-align="center">
                                                            ${Static["org.sitenetsoft.sunseterp.applications.party.party.PartyHelper"].getPartyName(delegator, payment.partyIdTo, false)}
                                                        </fo:block>
                                                    </fo:table-cell>
                                                    <fo:table-cell padding="3pt" number-columns-spanned="4" text-align="center">
                                                        <fo:block text-align="center">${payment.effectiveDate?date?string.short}</fo:block>
