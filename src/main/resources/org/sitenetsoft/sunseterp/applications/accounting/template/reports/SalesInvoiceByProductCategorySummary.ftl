...
<ul>
    ...
    <li>Root Category: ${(Static["org.sitenetsoft.sunseterp.applications.product.category.CategoryContentWrapper"].getProductCategoryContentAsText(rootProductCategory, "CATEGORY_NAME", locale, dispatcher, "html"))!} [${rootProductCategoryId}]</li>
...
<table class="basic-table" cellspacing="0">
    ...
    <#list productList as product>
        <td>${product.internalName?default((Static["org.sitenetsoft.sunseterp.applications.product.product.ProductContentWrapper"].getProductContentAsText(product, "PRODUCT_NAME", locale, dispatcher, "html"))!)}<br />P:[${product.productId}]</td>
    </#list>
    <#list productCategoryList as productCategory>
        <td>${(Static["org.sitenetsoft.sunseterp.applications.product.category.CategoryContentWrapper"].getProductCategoryContentAsText(productCategory, "CATEGORY_NAME", locale, dispatcher, "html"))!}<br />C:[${productCategory.productCategoryId}]</td>
    </#list>
    </tr>
    <#-- Days of the month -->
