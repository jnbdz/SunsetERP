        ...
        <table width="100%" cellspacing="0" cellpadding="1" border="0">
          ...
          <#if (shipGroups.size() > 0)>
            ...
            <#list shipGroups as group>
              <#assign shipEstimateWrapper = Static["org.sitenetsoft.sunseterp.applications.order.shoppingcart.shipping.ShippingEstimateWrapper"].getWrapper(dispatcher, cart, groupIdx)>
                ...
                <td>
                  <div class="tabletext">
                    <#if cartLine.getProductId()??>
                      ...
                      <#assign smallImageUrl = Static["org.sitenetsoft.sunseterp.applications.product.product.ProductContentWrapper"].getProductContentAsText(cartLine.getProduct(), "SMALL_IMAGE_URL", locale, dispatcher, "url")!>
