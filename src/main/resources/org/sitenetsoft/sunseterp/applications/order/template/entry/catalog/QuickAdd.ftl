        ...
        <form name="choosequickaddform" method="post" action="<@ofbizUrl>quickadd</@ofbizUrl>" style='margin: 0;'>
          <select name='category_id'>
            ...
            <#list quickAddCats as quickAddCatalogId>
              <#assign loopCategory = delegator.findOne("ProductCategory", Static["org.sitenetsoft.sunseterp.framework.base.util.UtilMisc"].toMap("productCategoryId", quickAddCatalogId), true)>
