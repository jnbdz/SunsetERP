...
<#-- company postal addresses -->
        ...
        <#if shipToPartyShippingContactMechList?has_content>
          <tr><td colspan="4"><hr /></td></tr>
          <tr><td colspan="4">${uiLabelMap.OrderShipToAnotherParty}: <b>${Static["org.sitenetsoft.sunseterp.applications.party.party.PartyHelper"].getPartyName(shipToParty)}</b></td></tr>
          <tr><td colspan="4"><hr /></td></tr>
          ...
          <td>
            ...
            <#list 1..cart.getShipGroupSize() as currIndex>
              ...
              <table width="100%" border="0" cellpadding="1" cellspacing="0">
                    ...
                    <div>
                      ...
                      <select name="${shipGroupIndex?default("0")}_supplierPartyId">
                        ...
                        <#list suppliers as supplier>
                          <option value="${supplier.partyId}"<#if supplierPartyId??><#if supplier.partyId == supplierPartyId> selected="selected"</#if></#if>>${Static["org.sitenetsoft.sunseterp.applications.party.party.PartyHelper"].getPartyName(supplier, true)}</option>
                        </#list>
                      </select>
                ...
                <#if shipToPartyShippingContactMechList?has_content>
                  <tr><td colspan="3"><hr /></td></tr>
                  <tr><td colspan="3">${uiLabelMap.OrderShipToAnotherParty}: <b>${Static["org.sitenetsoft.sunseterp.applications.party.party.PartyHelper"].getPartyName(shipToParty)}</b></td></tr>
                  <tr><td colspan="3"><hr /></td></tr>
                  <#list shipToPartyShippingContactMechList as shippingContactMech>
                    <#assign shippingAddress = shippingContactMech.getRelatedOne("PostalAddress", false)>
                    <tr>
