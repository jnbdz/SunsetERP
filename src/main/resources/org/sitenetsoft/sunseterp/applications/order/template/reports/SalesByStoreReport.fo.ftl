...
<#if productReportList?has_content>
        ...
        <fo:flow flow-name="xsl-region-body" font-family="Helvetica">
            ...
            <#if !showToParty><fo:block font-size="10pt">${uiLabelMap.PartyParty}: ${Static["org.sitenetsoft.sunseterp.applications.party.party.PartyHelper"].getPartyName(delegator, toPartyId, false)}</fo:block></#if>
