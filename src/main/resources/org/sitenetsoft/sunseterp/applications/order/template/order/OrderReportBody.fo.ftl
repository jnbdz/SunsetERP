        ...
        <fo:table table-layout="fixed" border-spacing="3pt">
            ...
            <fo:table-body>
                <#list orderItemList as orderItem>
                    ...
                    <#assign itemAdjustment = Static["org.sitenetsoft.sunseterp.applications.order.order.OrderReadHelper"].getOrderItemAdjustmentsTotal(orderItem, orderAdjustments, true, false, false)>
                    <#assign internalImageUrl = Static["org.sitenetsoft.sunseterp.applications.product.imagemanagement.ImageManagementHelper"].getInternalImageUrl(request, productId!)!>
                    <fo:table-row>
                        <fo:table-cell>
                            <fo:block>
                            ...
                            <fo:table-row>
                                ...
                                <fo:table-cell number-columns-spanned="2">
                                    ...
                                    <#if note.noteParty?has_content>
                                        <#assign notePartyNameResult = dispatcher.runSync("getPartyNameForDate", Static["org.sitenetsoft.sunseterp.framework.base.util.UtilMisc"].toMap("partyId", note.noteParty, "compareDate", note.noteDateTime, "lastNameFirst", "Y", "userLogin", userLogin))/>
