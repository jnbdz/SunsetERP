                ...
                <select name='paymentMethodId'>
                  ...
                  <#if creditCardList?has_content>
                    <#list creditCardList as creditCardPm>
                      ...
                      <option value="${creditCard.paymentMethodId}">CC:&nbsp;${Static["org.sitenetsoft.sunseterp.applications.party.contact.ContactHelper"].formatCreditCard(creditCard)}</option>
                    </#list>
                  </#if>
