                ...
                <fo:table-row>
                    <fo:table-cell>
                        <fo:block>
                            ...
                            <#if quote.partyId??>
                                <#assign quotePartyNameResult = dispatcher.runSync("getPartyNameForDate", Static["org.sitenetsoft.sunseterp.framework.base.util.UtilMisc"].toMap("partyId", quote.partyId, "compareDate", quote.issueDate, "userLogin", userLogin))/>
        ...
        <fo:table table-layout="fixed" border-spacing="3pt" space-before="0.5in" space-after="0.5in">
            ...
            <fo:table-body>
                ...
                <fo:table-row>
                    ...
                    <#assign quoteLevelTerms = Static["org.sitenetsoft.sunseterp.framework.entity.util.EntityUtil"].filterByAnd(quoteTerms, {"quoteItemSeqId": "_NA_"})!>
