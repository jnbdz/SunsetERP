    ...
    <table width="100%">
      ...
      <tr>
        ...
        <td rowspan="${numberOfItems}">
          <#assign contactMech = delegator.findOne("ContactMech", Static["org.sitenetsoft.sunseterp.framework.base.util.UtilMisc"].toMap("contactMechId", cartShipInfo.contactMechId), false)! />
        ...
        <td rowspan="${numberOfItems}" valign="top">
          <#assign supplier =  delegator.findOne("PartyGroup", Static["org.sitenetsoft.sunseterp.framework.base.util.UtilMisc"].toMap("partyId", cartShipInfo.getSupplierPartyId()), false)! />
        ...
        <td rowspan="${numberOfItems}" valign="top">
          <#assign carrier =  delegator.findOne("PartyGroup", Static["org.sitenetsoft.sunseterp.framework.base.util.UtilMisc"].toMap("partyId", cartShipInfo.getCarrierPartyId()), false)! />
          <#assign method =  delegator.findOne("ShipmentMethodType", Static["org.sitenetsoft.sunseterp.framework.base.util.UtilMisc"].toMap("shipmentMethodTypeId", cartShipInfo.getShipmentMethodTypeId()), false)! />
