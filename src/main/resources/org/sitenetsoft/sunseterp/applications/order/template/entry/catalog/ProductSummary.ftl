          ...
          <#else>
            ...
            <#if mainProducts?has_content>
              ...
              <#if prodCatMem?? && prodCatMem.quantity?? && 0.00 < prodCatMem.quantity?double>
                ...
                <#assign productCategory = delegator.findOne("ProductCategory", Static["org.sitenetsoft.sunseterp.framework.base.util.UtilMisc"].toMap("productCategoryId", prodCatMem.productCategoryId), false)/>
