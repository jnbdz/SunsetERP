      ...
      <#if quoteRoles?has_content>
        <table cellspacing="0" class="basic-table">
            ...
            <#list quoteRoles as quoteRole>
                ...
                <#assign rolePartyNameResult = dispatcher.runSync("getPartyNameForDate", Static["org.sitenetsoft.sunseterp.framework.base.util.UtilMisc"].toMap("partyId", quoteRole.partyId, "compareDate", quote.issueDate, "userLogin", userLogin))/>
                <tr>
