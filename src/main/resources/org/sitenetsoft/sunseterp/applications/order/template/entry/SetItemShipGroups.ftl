        ...
        <tr>
          <td>
            <#list 1..shoppingCart.getShipGroupSize() as currIndex>
              ...
              <#assign supplier =  delegator.findOne("PartyGroup", Static["org.sitenetsoft.sunseterp.applications.base.util.UtilMisc"].toMap("partyId", shoppingCart.getSupplierPartyId(shipGroupIndex)), false)! />
