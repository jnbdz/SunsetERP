                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell padding="2pt" background-color="${rowColor}">
                                ...
                                <#if quoteItem.quoteItemSeqId?has_content>
                                    <#assign quoteItemLevelTerms = Static["org.sitenetsoft.sunseterp.framework.entity.util.EntityUtil"].filterByAnd(quoteTerms, {"quoteItemSeqId": quoteItem.quoteItemSeqId})!>
