...
<#assign components = Static["org.sitenetsoft.sunseterp.framework.base.component.ComponentConfig"].getAllComponents()!/>
<#if (requestParameters.certString?has_content)>
    <#assign cert = Static["org.sitenetsoft.sunseterp.framework.base.util.KeyStoreUtil"].pemToCert(requestParameters.certString)/>
</#if>
