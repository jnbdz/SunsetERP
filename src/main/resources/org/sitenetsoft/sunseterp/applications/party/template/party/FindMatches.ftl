              ...
              <table cellspacing="0" class="basic-table">
                ...
                <#list matches as match>
                  ...
                  <tr>
                    ...
                    <td>${Static["org.sitenetsoft.sunseterp.applications.party.party.PartyWorker"].makeMatchingString(delegator, match.address1)}</td>
                    <td>${Static["org.sitenetsoft.sunseterp.applications.party.party.PartyWorker"].makeMatchingString(delegator, match.address2?default("N/A"))}</td>
                    <td>${match.city}</td>
