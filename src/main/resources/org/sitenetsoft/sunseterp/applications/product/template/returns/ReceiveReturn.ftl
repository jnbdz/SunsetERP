...
<div class="screenlet">
    ...
    <div class="screenlet-body">
        ...
        <#if receivedItems?has_content>
          <h3>${uiLabelMap.ProductReceiptForReturn} ${uiLabelMap.CommonNbr}<a href="<@ofbizUrl controlPath="/ordermgr/control">returnMain?returnId=${returnHeader.returnId}</@ofbizUrl>" class="buttontext">${returnHeader.returnId}</a></h3>
        ...
        <#if returnHeader?has_content>
          <form method="post" action="<@ofbizUrl>receiveReturnedProduct</@ofbizUrl>" name='selectAllForm'>
            ...
            <#assign now = Static["org.sitenetsoft.sunseterp.framework.base.util.UtilDateTime"].nowTimestamp().toString()>
            <#assign rowCount = 0>
            <table cellspacing="0" class="basic-table">
              ...
              <#else>
                <tr>
                  <td>
                    <h3>
                      ${uiLabelMap.ProductReceiveReturn} <a href="<@ofbizUrl controlPath="/ordermgr/control">returnMain?returnId=${returnHeader.returnId}</@ofbizUrl>" class="buttontext">#${returnHeader.returnId}</a>
                ...
                <#list returnItems as returnItem>
                  ...
                  <#assign unitCost = Static["org.sitenetsoft.sunseterp.applications.order.order.OrderReturnServices"].getReturnItemInitialCost(delegator, returnItem.returnId, returnItem.returnItemSeqId)/>
                  <tr>
                    <td colspan="2"><hr/></td>
                  </tr>
                  <tr>
                      ...
                      <table cellspacing="0" class="basic-table">
                        <tr>
                          ...
                          <#if orderItem.productId??>
                            ...
                            <#assign serializedInv = product.getRelated("InventoryItem", Static["org.sitenetsoft.sunseterp.framework.base.util.UtilMisc"].toMap("inventoryItemTypeId", "SERIALIZED_INV_ITEM"), null, false)>
                            <input type="hidden" name="productId_o_${rowCount}" value="${product.productId}" />
                            <td width="45%">
                              <div>
                                ${returnItem.returnItemSeqId}:&nbsp;<a href="<@ofbizUrl controlPath="/catalog/control">EditProduct?productId=${product.productId}</@ofbizUrl>" target="catalog" class="buttontext">${product.productId}&nbsp;-&nbsp;${product.internalName!}</a> : ${product.description!}
                          ...
                          <td align="right">
                            <#assign facilityLocations = (product.getRelated("ProductFacilityLocation", Static["org.sitenetsoft.sunseterp.framework.base.util.UtilMisc"].toMap("facilityId", facilityId), null, false))!>
