...
<#if productCategoryId?? && productCategory??>
    <div class="screenlet">
        ...
        <div class="screenlet-body">
            ...
            <#if (productCategoryRole.getTimestamp("fromDate"))?? && Static["org.sitenetsoft.sunseterp.framework.base.util.UtilDateTime"].nowTimestamp().before(productCategoryRole.getTimestamp("fromDate"))> <#assign hasntStarted = true></#if>
            ...
            <td align="center">
                <form method="post" action="<@ofbizUrl>updatePartyToCategory</@ofbizUrl>" name="lineForm_update${line}">
                    ...
                    <#if (productCategoryRole.getTimestamp("thruDate"))?? && (Static["org.sitenetsoft.sunseterp.framework.base.util.UtilDateTime"].nowTimestamp().after(productCategoryRole.getTimestamp("thruDate")))> <#assign hasExpired = true></#if>
                    ...
                    <@htmlTemplate.renderDateTimeField name="thruDate" event="" action="" className="${class!}" title="Format: yyyy-MM-dd HH:mm:ss.SSS" value="${(productCategoryRole. getTimestamp('thruDate'))!}" size="25" maxlength="30" id="thruDate_1" isDateType=true shortDateInput=false timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName=""/>
