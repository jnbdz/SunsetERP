...
<form method="post" action="<@ofbizUrl>SearchInventoryItemsByLabels</@ofbizUrl>">
  ...
  <#list labelTypes as labelType>
    ...
    <#assign labels = labelType.getRelated("InventoryItemLabel", null, Static["org.sitenetsoft.sunseterp.framework.base.util.UtilMisc"].toList("inventoryItemLabelId"), false)>
    <tr>
      <td>
          <div>
