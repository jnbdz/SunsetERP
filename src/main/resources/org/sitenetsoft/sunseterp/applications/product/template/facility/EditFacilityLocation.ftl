...
<#if facilityId?? && locationSeqId??>
  <div class="button-bar">
    ...
    <#assign latestGeoPoint= Static["org.sitenetsoft.sunseterp.framework.common.geo.GeoWorker"].findLatestGeoPoint(delegator, "FacilityLocationAndGeoPoint", "facilityId", facilityId, "locationSeqId", locationSeqId)!/>
