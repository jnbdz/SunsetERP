...
under the License.
-->
<#assign contentURL = Static["org.sitenetsoft.sunseterp.framework.entity.util.EntityUtilProperties"].getPropertyValue("url", "content.url.prefix.standard", delegator)>
