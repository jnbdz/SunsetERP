       ...
       <#if !(inventoryItem??)>
        ...
        <#else>
            ...
            <tr>
                ...
                <td width="6%" align="right" nowrap="nowrap"><span class="label">${uiLabelMap.ProductToFacilityContainer}</span></td>
                <td width="6%">&nbsp;</td>
                <#assign fac = delegator.findOne("Facility", Static["org.sitenetsoft.sunseterp.framework.base.util.UtilMisc"].toMap("facilityId", inventoryTransfer.facilityIdTo), false)>
