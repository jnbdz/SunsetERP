            ...
            <tr class="header-row">
                <td>${uiLabelMap.ProductProductId}</td>
                    <#list featureTypeIds as featureTypeId>
                        <#assign featureType = delegator.findOne("ProductFeatureType", Static["org.sitenetsoft.sunseterp.framework.base.util.UtilMisc"].toMap("productFeatureTypeId", featureTypeId), false)>
