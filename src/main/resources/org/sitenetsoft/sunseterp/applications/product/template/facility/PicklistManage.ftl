    ...
    <#if picklistInfoList?has_content>
      <#list picklistInfoList as picklistInfo>
        ...
        <#list picklistInfo.picklistBinInfoList! as picklistBinInfo>
          <#assign isBinComplete = Static["org.sitenetsoft.sunseterp.applications.shipment.picklist.PickListServices"].isBinComplete(delegator, picklistBinInfo.picklistBin.picklistBinId)/>
          <#if (!isBinComplete)>
            <div style="margin-left: 15px;">
