...
import org.sitenetsoft.sunseterp.framework.widget.model.FormFactory
    ...
    dynamicAutoEntityFieldListForm += """
            <field name="viewGeneric" title=" ">
                <hyperlink description="view"
                    target="\${groovy: 'entity/find/' + org.sitenetsoft.sunseterp.framework.entity.util.EntityUtil.entityToPath(delegator, '${entityName}', context)}"/>
            </field>
