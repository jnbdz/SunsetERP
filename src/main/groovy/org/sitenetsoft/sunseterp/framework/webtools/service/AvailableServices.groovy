...
List getEcaListForService(String selectedService) {
    ecaMap = org.sitenetsoft.sunseterp.framework.service.eca.ServiceEcaUtil.getServiceEventMap(selectedService)
        ...
        ecaValue.each { curRule ->
            ...
            if (actionsVal) {
                ...
                actionsVal.each { curAction ->
                    ...
                    if (org.sitenetsoft.sunseterp.framework.service.eca.ServiceEcaAction == actionClass) {
                        actionMap = [:]
