 ...
 * under the License.
*/
package org.sitenetsoft.sunseterp.applications.party
...
context.hasPayInfoPermission = ['PAY_INFO', 'ACCOUNTING'].any { entity -> security.hasEntityPermission(entity, '_VIEW', session) }
