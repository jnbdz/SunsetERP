 ...
 * under the License.
*/
package org.sitenetsoft.sunseterp.applications.product.catalog.product
...
import org.sitenetsoft.sunseterp.applications.product.inventory.InventoryWorker
...
if (product) {
    ...
    if (product.isVirtual && product.isVirtual == 'Y') {
        ...
        if (showAllFacilities && showAllFacilities == 'Y') {
        ...
        showEmpty = request.getParameter('showEmpty') == 'true'
