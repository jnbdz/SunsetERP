 ...
 * under the License.
*/
package org.sitenetsoft.sunseterp.applications.workeffort.workeffort.calendar
...
serviceCtx.putAll([userLogin: userLogin, start: start, numPeriods: 7, periodType: Calendar.DATE, locale: locale, timeZone: timeZone])
