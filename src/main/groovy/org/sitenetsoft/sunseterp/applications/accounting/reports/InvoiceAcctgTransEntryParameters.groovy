 ...
 * under the License.
*/
package org.sitenetsoft.sunseterp.applications.accounting.reports
...
partyId = null
if (invoice.get('invoiceTypeId') == 'PURCHASE_INVOICE'
        || invoice.getRelatedOne('InvoiceType', false).get('parentTypeId') == 'PURCHASE_INVOICE') {
