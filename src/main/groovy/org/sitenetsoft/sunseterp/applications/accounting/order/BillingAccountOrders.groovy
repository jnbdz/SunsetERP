 ...
 * under the License.
*/
package org.sitenetsoft.sunseterp.applications.accounting.order
...
if (billingAccountId) {
    ...
    if (orderList) {
        orderList.each { orderHeader ->
            ...
            orderBillingAccMap = [:]
            if (orderBillingAcc.paymentMethodTypeId == 'EXT_BILLACT' && orderBillingAcc.paymentStatusId == 'PAYMENT_NOT_RECEIVED') {
